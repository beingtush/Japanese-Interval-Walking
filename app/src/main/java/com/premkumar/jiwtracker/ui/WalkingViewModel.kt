package com.premkumar.jiwtracker.ui
...
class WalkingViewModel(
    ...
    val onboardingPrefs = com.premkumar.jiwtracker.data.OnboardingPrefs(application)
    ...
    fun setOnboardingWeight(weight: Float) {
        viewModelScope.launch {
            ...
            com.premkumar.jiwtracker.data.OnboardingAnalytics.logEvent("weight_saved", mapOf("weight" to weight))
        }
    }
    ...
    fun setWeeklyWalkGoal(goal: Int) {
        viewModelScope.launch {
            ...
            com.premkumar.jiwtracker.data.OnboardingAnalytics.logEvent("weekly_goal_saved", mapOf("goal" to goal))
        }
    }
    ...
    fun resetOnboarding() {
        viewModelScope.launch {
            ...
            com.premkumar.jiwtracker.data.OnboardingAnalytics.logEvent("onboarding_reset")
        }
    }
    ...
    fun replayAppTour() {
        viewModelScope.launch {
            ...
            com.premkumar.jiwtracker.data.OnboardingAnalytics.logEvent("onboarding_replayed")
        }
    }

    fun logOnboardingEvent(event: String, params: Map<String, Any> = emptyMap()) {
        com.premkumar.jiwtracker.data.OnboardingAnalytics.logEvent(event, params)
    }
    ...
    val healthConnectManager = com.premkumar.jiwtracker.data.HealthConnectManager(application)
    val healthConnectPermissionManager = com.premkumar.jiwtracker.data.HealthConnectPermissionManager(application)
    ...
    val lastSyncMetadata: StateFlow<com.premkumar.jiwtracker.data.SyncMetadata> = _lastSyncMetadata.asStateFlow()
