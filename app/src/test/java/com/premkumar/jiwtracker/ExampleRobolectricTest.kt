...
class ExampleRobolectricTest {
  ...
  fun `read string from context`() {
    ...
    assertEquals("JIW Tracker", appName)
  }
  ...
  fun `verify database initialization and viewModel creation`() {
    ...
    assertEquals(3, com.premkumar.jiwtracker.service.WalkingForegroundService.slowDurationMinutes)
    assertEquals(3, com.premkumar.jiwtracker.service.WalkingForegroundService.fastDurationMinutes)
    assertEquals(5, com.premkumar.jiwtracker.service.WalkingForegroundService.selectedCycles)
  }
